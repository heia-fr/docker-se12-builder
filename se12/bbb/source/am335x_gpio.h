 ...
 * configured as interrupt source, the interrupt source is enabled
 * after attachment.
 *
 * @param port gpio module name to which the ISR should be attached
 ...
 * @param pin_nr pin number from which the ISR should be detached
 */
extern void am335x_gpio_detach (enum am335x_gpio_modules module, uint32_t pin_nr);
 ...
 */
extern void am335x_gpio_disable(enum am335x_gpio_modules module, uint32_t pin);


/**
 * interrutp service routine. Should be attach to INTC for processing
 */
extern void am335x_gpio_interrupt_hanlder (enum am335x_gpio_modules module);
